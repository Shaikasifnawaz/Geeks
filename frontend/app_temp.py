...
st.markdown(
    ...
    <style>
        ...
        .chat-widget input[type="checkbox"]:checked ~ .chat-window {{
            opacity: 1;
            pointer-events: auto;
...
CHAT_MESSAGES = [
    {"sender": "Analyst Isla", "text": "xG trend +15% month-over-month.", "time": "08:45"},
    {"sender": "Coach Marcus", "text": "Focus training on wide overlaps.", "time": "08:47"},
    {"sender": "Data Ops", "text": "KPIs synced with scouting reports.", "time": "08:51"},
    {"sender": "Physio Lead", "text": "Two players on light recovery plans.", "time": "08:55"},
]


def render_chat_widget():
    """Inject floating chat widget with fake messages."""

    messages_html = "".join(
        f"""
        <div class="chat-message {'user' if 'Analyst' not in msg['sender'] and 'Coach' not in msg['sender'] and 'Data' not in msg['sender'] and 'Physio' not in msg['sender'] else 'agent'}">
        ...
        <div class="chat-widget">
            ...
            <div class="chat-window">
                <div class="chat-header">
                    <span>Club Analyst Desk</span>
                    <label for="chat-toggle" class="close-chat">×</label>
                </div>
                <div class="chat-body">{messages_html}</div>
